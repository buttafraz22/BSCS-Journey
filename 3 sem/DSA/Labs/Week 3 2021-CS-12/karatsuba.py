# -*- coding: utf-8 -*-
"""
Created on Fri Sep 16 19:12:24 2022
...
def Karatsuba_Recursive(a , b):
    ...
    if n <= 1:
        ...
        xc = Karatsuba_Recursive(x, c)
        yd = Karatsuba_Recursive(y,d)
        xy = Karatsuba_Recursive(x+y, c+d) - xc - yd
